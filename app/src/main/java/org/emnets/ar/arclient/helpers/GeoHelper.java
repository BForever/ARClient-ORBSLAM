...
import org.emnets.ar.arclient.CameraPose;
...
public class GeoHelper {
    ...
    public static Quaternion eulerAngles(Vector3 var0) {
        Quaternion var1 = new Quaternion(Vector3.right(), var0.y);
        Quaternion var2 = new Quaternion(Vector3.up(), var0.x);
        Quaternion var3 = new Quaternion(Vector3.back(), var0.z);

        return multiply(multiply(var2, var1), var3);
    }
